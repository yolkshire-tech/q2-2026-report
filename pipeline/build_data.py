...
Inputs (relative to repo root):
  data/pos/Q1/{Jan,Feb,Mar}-2026 - Sale Transactions.csv     invoice-level, Q1
  data/pos/Q2/{Apr,May,Jun}-2026 - Sale Transactions.csv     invoice-level, Q2
  data/pos/Q2/Multidate - Sales By Items.csv                 item-line, Q2
  data/reference/fastest_growing.json                    item growth (Apr vs Jun qty)
  data/reference/declining_items.json                    item decline
...
def load_transactions():
    ...
    for q, months in (("Q1", ["Jan", "Feb", "Mar"]), ("Q2", ["Apr", "May", "Jun"])):
        for m in months:
            f = ROOT / "data" / "pos" / q / f"{m}-2026 - Sale Transactions.csv"
...
def main():
    ...
    # "data/cost-actuals/" using pipeline/cost_actuals_template.csv columns
    ...
    if ca_dir.exists():
        ...
        print("  cost actuals: none found in data/cost-actuals/")

    print("[5] Menu items (Q2 item-line, full coverage)")
    items = pd.read_csv(ROOT / "data" / "pos" / "Q2" / "Multidate - Sales By Items.csv",
                        encoding="utf-8")
    ...
    grow = json.load(open(ROOT / "data" / "reference" / "fastest_growing.json", encoding="utf-8"))
    decl = json.load(open(ROOT / "data" / "reference" / "declining_items.json", encoding="utf-8"))
    ...
    header = (
        ...
        "// Source: raw POS exports in data/pos/Q1 + data/pos/Q2 (see Docs/Revenue_Baseline_Reconciliation.md).\n"
